...
namespace Webber.API.Tests.Integration.Controllers;

public class AuthenticationControllerTests(CustomWebApplicationFactory<Program> factory)
    : IClassFixture<CustomWebApplicationFactory<Program>>
{
    private readonly HttpClient _client = factory.CreateClient(); // HTTP client for making requests to the API

    /// <summary>
    /// Tests that a valid user registration request returns a Created status.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that registering an existing username returns a BadRequest status.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that registering with an existing email returns a BadRequest status.
    /// </summary>
    [Fact]
    public async Task Register_ExistingEmail_ReturnsBadRequest()
    {
        ...
        {
            Username = "admin",
            Email = "admin@Webber.com", // Existing email
            Password = "@Asd123456",
            ConfirmPassword = "@Asd123456",
            FirstName = "Test",
            LastName = "User",
    ...
    /// <summary>
    /// Tests that logging in with valid credentials returns an Ok status with a token.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that logging in with invalid credentials returns an Unauthorized status.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that refreshing a valid refresh token returns an Ok status with a new token.
    /// </summary>
    [Fact]
    public async Task RefreshToken_ValidRefreshToken_ReturnsOkWithNewToken()
    {
        ...
        // Create a RefreshTokenDto with the obtained refresh token
    ...
    /// <summary>
    /// Tests that refreshing an invalid refresh token returns an Unauthorized status.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that a valid password reset request returns an Ok status.
    /// </summary>
    [Fact]
    public async Task ForgotPassword_ValidEmail_ReturnsOk()
    {
        // Arrange
        var email = "admin@Webber.com";
    ...
    /// <summary>
    /// Tests that requesting a password reset with an invalid email returns a NotFound status.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that resetting the password with a valid token returns an Ok status.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that resetting the password with an invalid token returns a BadRequest status.
    /// </summary>
    [Fact]
